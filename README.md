...
Chromium 86 not telemetry term check telemetry chrome://terms/ download V86 ffmpeg support https://yadi.sk/d/JNVgMB_wExINeQ install command:
...
find (tab-groups-collapse) enabled apple resart browser
