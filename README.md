...
Пока не понятно почему не работает вулкан хотя ранее удавалось включить его поддержку в более ранних версиях только они не могли совместно работать с opengl , skia или с чем то из них (точно не помню)  заити можно посмотреть по адресу chrome://gpu/ Vulkan: Disabled
